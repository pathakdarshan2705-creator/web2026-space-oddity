...
- [Flexbox Froggy](https://flexboxfroggy.com): levels 1 to 13 cover everything here
- [A Complete Guide to Flexbox (CSS-Tricks)](https://css-tricks.com/snippets/css/a-guide-to-flexbox/)
- [MDN: basic concepts of flexbox](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_flexible_box_layout/Basic_concepts_of_flexbox)

## Image credits

Artwork is public domain via [The Met Open Access](https://www.metmuseum.org/about-the-met/policies-and-documents/open-access): *Wheat Field with Cypresses* (Van Gogh), *Under the Wave off Kanagawa* (Hokusai), *Young Woman with a Water Pitcher* (Vermeer), *The Harvesters* (Bruegel).
